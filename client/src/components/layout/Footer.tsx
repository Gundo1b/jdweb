      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/Contact" className="text-gray-300 hover:text-white transition-colors">Matric Upgrade</Link></li>
              <li><Link href="/Contact" className="text-gray-300 hover:text-white transition-colors">Saturday School</Link></li>
              <li><Link href="/Contact" className="text-gray-300 hover:text-white transition-colors">Extra Classes</Link></li>
              <li><Link href="/Contact" className="text-gray-300 hover:text-white transition-colors">Varsity / College Tutoring</Link></li>
              <li><Link href="/Contact" className="text-gray-300 hover:text-white transition-colors">In-Person Classes</Link></li>
            </ul>
          </div>
